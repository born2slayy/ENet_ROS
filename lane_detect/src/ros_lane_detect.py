...
class LaneDetectNode(object):
    def __init__(self, model, args=None):
        rospy.init_node('lane_detection_line', anonymous=True)
    ...
    def sub_lane(self, img):
        if self.image_lock.acquire(True):
            ...
            sem_pred = ndi.binary_fill_holes(sem_pred > 0.5)
...
#     try:
#         # rospy.init_node('lane_detection_line')
